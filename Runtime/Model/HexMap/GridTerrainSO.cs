...
namespace LZ.WarGameMap.Runtime
{
    public class BaseGridTerrain
    {
        ...
        public static GridTerrainLayer BaseLayer =      new GridTerrainLayer(0, "������ò��", "", true);
        public static GridTerrainLayer LandformLayer =  new GridTerrainLayer(1, "���ӵ�ò��", "", true);
        public static GridTerrainLayer DecorateLayer =  new GridTerrainLayer(2, "װ�β�", "", true);
        public static GridTerrainLayer DynamicLayer =   new GridTerrainLayer(3, "��̬��", "", true);
        ...
        public static GridTerrainType HillType =        new GridTerrainType(0, "Hill",      "����",   new Color(0.40f, 0.60f, 0.30f, 1.0f), true);
        public static GridTerrainType MountainType =    new GridTerrainType(0, "Mountain",  "ɽ��",   new Color(0.50f, 0.45f, 0.40f, 1.0f), true);
        public static GridTerrainType PlateauType =     new GridTerrainType(0, "Plateau",   "��ԭ",   new Color(0.70f, 0.60f, 0.35f, 1.0f), true);
        public static GridTerrainType SnowType =        new GridTerrainType(0, "Snow",      "ѩ��",   new Color(1, 1, 1, 1.0f), true);

        public static GridTerrainType TropicalType = new GridTerrainType(1, "Tropical", "�ȴ�", new Color(0.90f, 0.75f, 0.30f, 1), true);
        public static GridTerrainType SubtropicsType = new GridTerrainType(1, "Subtropics", "���ȴ�", new Color(0.78f, 0.85f, 0.40f, 1), true);
        public static GridTerrainType TemperateType = new GridTerrainType(1, "Temperate", "�´�", new Color(0.65f, 0.80f, 0.55f, 1), true);
        public static GridTerrainType CoastType = new GridTerrainType(1, "Coast", "����", new Color(0.85f, 0.90f, 0.65f, 1), true);
        public static GridTerrainType SandType = new GridTerrainType(1, "Sand", "ɳĮ", new Color(0.92f, 0.78f, 0.68f, 1), true);
        //public static GridTerrainType SandType = new GridTerrainType(1, "Sand", "����", new Color(0.92f, 0.78f, 0.68f, 1), true);

        public static GridTerrainType WetlandType = new GridTerrainType(2, "Wetland", "ʪ��", new Color(0.30f, 0.55f, 0.45f, 1), true);
        public static GridTerrainType ForestType = new GridTerrainType(2, "Forest", "ɭ��", new Color(0.20f, 0.50f, 0.25f, 1), true);
        public static GridTerrainType FarmlandType = new GridTerrainType(2, "Farmland", "ũ��", new Color(0.80f, 0.75f, 0.45f, 1), true);
        public static GridTerrainType TownType = new GridTerrainType(2, "Town", "����", new Color(0.70f, 0.60f, 0.55f, 1), true);
        public static GridTerrainType CityType = new GridTerrainType(2, "City", "����", new Color(0.55f, 0.55f, 0.65f, 1), true);

        public static GridTerrainType WastelandType = new GridTerrainType(3, "Wasteland", "����", new Color(0.70f, 0.55f, 0.35f, 1), true);
        public static GridTerrainType FloodingType = new GridTerrainType(3, "Flooding", "����", new Color(0.15f, 0.50f, 0.75f, 1), true);
    ...
    public class GridTerrainSO : ScriptableObject
    {
        ...
        public List<uint4> HexmapGridTerTypeList = new List<uint4>();           // uint4 : type[x][0] - x grid's layer 0, type[x][1] - x grid's  layer 1 (基本地形层), 以此类推
        ...
        // 根据 terrainEditColor 反向查找在 GridTerrainTypeList 中的 index
        // 前置条件：所有 GridTerrainType.terrainEditColor 唯一
        // 用途：从颜纹理反查地形 ID（如从 GenGridEditSimple 导出的 PNG 恢复 typeIdx）
        ...
        {
            const float epsilon = 0.004f; // 1/255 ≈ 0.0039, 加点余量
